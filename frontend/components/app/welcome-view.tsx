...
export const WelcomeView = ({
  ...
  return (
    <div
      ref={ref}
      className="w-full h-svh overflow-hidden bg-[#050505] text-white flex flex-col relative"
    ...
    >
      ...
      {/* ─── Hero Content ─── */}
      <div className="relative z-20 flex-1 flex flex-col items-center justify-center px-4 w-full h-full pb-20 md:pb-10">
        <motion.div
